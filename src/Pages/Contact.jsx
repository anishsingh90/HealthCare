...
function Contact() {
  const address = '	UNITON Space, Opp:Raheja Mind Space IT, Plot NO: 301, HITEC City, Hyderabad, Telangana 500072';
  const googleMapsUrl = `https://maps.app.goo.gl/eaQdWEA2noFAeJjV8${encodeURIComponent(
    address
  )}`;
